//*----------------------------------------------------------------------------
// Classe : FormJournaux
// Fonctions : Journaux avec analytique
// 
//  
...
{
    /// <summary>
    /// FormJournaux :  Journaux avec analytique
    /// </summary>

    public partial class FormJournaux : Form
    {
        ...
        /// <param name="e"></param>
        /// 
        private void FormJournaux_Load(object sender, EventArgs e)
        {
            this.Text = "Journaux";
            toolTipJournaux.ToolTipTitle = "Journaux";
        ...
        {
            // TODO: Affichage de l'aide:Journaux avec analytique
       ...
       private void buttonAnnuler_Click(object sender, EventArgs e)
        ...
        /// <summary>
        /// Enregistrement des modifications de journaux
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
